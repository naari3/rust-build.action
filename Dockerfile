...
RUN apk add --no-cache curl=7.83.1-r3 jq=1.6-r1 git=2.36.2-r0 build-base=0.5-r3 bash=5.1.16-r2 \
...
RUN apk add --no-cache clang=13.0.1-r1 cmake=3.23.1-r0 libxml2-dev=2.9.14-r1 \
  openssl-dev=1.1.1q-r0 fts-dev=1.2.7-r1 bsd-compat-headers=0.7.2-r3 xz=5.2.5-r1
